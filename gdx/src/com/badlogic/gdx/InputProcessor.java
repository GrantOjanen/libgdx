...
public interface InputProcessor {
	 ...
	 * @param device ID for the mouse/touchscreen device. Android only, returns -999 on other platforms
	 ...
	 * @param device ID for the touchscreen/mouse device. Android only, returns -999 on other platforms
	 * @param pointer the pointer for the event.
	 * @return whether the input was processed */
	public boolean touchDragged (int device, int screenX, int screenY, int pointer);

	/** Called when the mouse was moved without any buttons being pressed. Will not be called on iOS.
	 * @param device ID for the mouse device. Android only, returns -999 on other platforms
	 * @return whether the input was processed */
	public boolean mouseMoved (int device, int screenX, int screenY);
